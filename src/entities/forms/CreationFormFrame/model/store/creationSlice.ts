...
export const creationSlice = createSlice({
  ...
  reducers: {
    ...
    setBlockQuestions: (state, action: PayloadAction<BlockEntity[]>) => {
      state.questionsBlock.questions = action.payload;
    },
    ...
    setBlockTests: (state, action: PayloadAction<BlockEntity[]>) => {
      state.testsBlock.tests = action.payload;
    },
